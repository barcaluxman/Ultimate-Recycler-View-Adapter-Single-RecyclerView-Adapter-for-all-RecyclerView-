package com.gurkhatech.mvppatterntest.colorlist.constants;

import android.content.Context;

import com.gurkhatech.mvppatterntest.colorlist.model.APIService;
...
import static com.gurkhatech.mvppatterntest.colorlist.constants.Constants.BASE_URL;
...
private RestClientStandAlone ( final Context context ) {
    ...
    OkHttpClient client = new OkHttpClient.Builder ().cache ( new Cache ( MyApplication.getInstance ().getApplicationContext ().getCacheDir (), 300 *1000*1000 ) ).addInterceptor ( interceptor ).build ();
...
public Object callForResponse ( final Call call ) {
